...
|--------|------------------|-------------|
| Scheme 0 | System lifetime only (black box) | `observe_scheme0()` |
| Scheme 1 | System lifetime + periodic component inspections | `observe_scheme1(delta)` |
| Scheme 2 | All component lifetimes exactly (complete data) | `observe_scheme2()` |
...
se_vec <- likelihood.model::se(mle0)
if (!any(is.na(se_vec))) {
