...
df <- rdata(model)(theta = c(1, 2, 3), n = 500)
result <- fit(model)(df, n_starts = 3)
...
| `fit_system(t, sys, family, ...)` | For k-of-n: `fit(kofn(k, m, family))(df, ...)`. For general coherent: roll your own optimizer with dist.structure densities. |
