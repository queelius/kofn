...
See Supplementary Material~A for the full argument.
\end{proof}
...
(Supplementary Material~B) provides $O(2^m)$ closed-form evaluations.
...
The online supplementary material contains: (A) the full proof of
\cref{prop:symmetry}, (B) the inclusion-exclusion expansion for
exponential parallel systems, and (C) pseudocode for the partial
autopsy likelihood enumeration (Algorithm~1).
